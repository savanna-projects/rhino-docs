...
7. If Rhino Server is up, running and accessible in the address provided under the project `Manifest.json`, the following confirmation will be displayed.  
...
5. When test invocation is complete, a report will be opened under a new `Visual Studio Code` tab. 
