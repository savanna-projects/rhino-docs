...
2. `date` - a macro for getting the current date and time. The `format` switch allows you to provide a [date-time format](https://docs.microsoft.com/en-us/dotnet/standard/base-types/standard-date-and-time-format-strings).
